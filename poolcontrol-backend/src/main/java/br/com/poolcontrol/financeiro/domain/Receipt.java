...
@Getter @Setter @Entity @Table(name="recebimentos")
public class Receipt extends BaseEntity {

  @Column(name="conta_receber_id",nullable=false) private UUID contaReceberId;
  @Column(name="parcela_receber_id") private UUID parcelaReceberId;
  ...
  @Column(name="data_recebimento",nullable=false) private LocalDate dataRecebimento;
  @Column(name="valor_principal",nullable=false,precision=19,scale=4) private BigDecimal valorPrincipal;
  ...
  @Column(name="valor_total",nullable=false,precision=19,scale=4) private BigDecimal valorTotal;
  @Column(name="estornado_em") private OffsetDateTime estornadoEm;
  @Column(name="estornado_por") private UUID estornadoPor;
  @Column(name="motivo_estorno",length=255) private String motivoEstorno;

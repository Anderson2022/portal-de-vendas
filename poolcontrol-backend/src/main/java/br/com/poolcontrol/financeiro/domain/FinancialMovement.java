...
@Getter @Setter @Entity @Table(name="movimentacoes_financeiras")
public class FinancialMovement extends BaseEntity {
  ...
  @Enumerated(EnumType.STRING) @Column(nullable=false,length=30) private MovementOrigin origem;

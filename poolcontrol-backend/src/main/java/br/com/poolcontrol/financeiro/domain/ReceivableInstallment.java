...
@Getter @Setter @Entity @Table(name="parcelas_receber")
public class ReceivableInstallment extends BaseEntity {
  ...
  @Column(nullable=false) private Integer parcela;
  @Column(nullable=false) private Integer totalParcelas;
  ...
  @Enumerated(EnumType.STRING) @Column(nullable=false,length=20) private InstallmentStatus status=InstallmentStatus.ABERTA;

...
SET
    criado_por_usuario_id = solicitado_por
WHERE
    criado_por_usuario_id IS NULL;

ALTER TABLE transferencias_estoque
ALTER COLUMN criado_por_usuario_id
SET
    NOT NULL;
...
ADD COLUMN status_novo VARCHAR(30);
...
INSERT INTO
    motivos_transferencia (empresa_id, codigo, nome)
SELECT
    id,
    'REPOSICAO',
    'Reposição de estoque'
FROM
    empresas ON CONFLICT DO NOTHING;

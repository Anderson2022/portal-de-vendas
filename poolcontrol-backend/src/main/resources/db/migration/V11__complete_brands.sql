...
CREATE INDEX IF NOT EXISTS idx_marcas_empresa_fabricante
    ON marcas (empresa_id, fabricante_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_marcas_empresa_codigo ON marcas (empresa_id, codigo) WHERE codigo IS NOT NULL;

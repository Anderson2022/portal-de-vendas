...
ALTER TABLE depositos ADD COLUMN unidade_estoque_id BIGINT REFERENCES unidades_estoque(id);
...
ALTER TABLE localizacoes_estoque
 ...
 ADD CONSTRAINT ck_localizacao_tipo CHECK (tipo IN ('AREA','CORREDOR','PRATELEIRA','LINHA','COLUNA','POSICAO'));

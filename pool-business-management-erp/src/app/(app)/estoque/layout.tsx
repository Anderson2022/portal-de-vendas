...
const items:SideItem[]=[
 ...
 {href:"/estoque?f=transferencias",label:"Transferências",icon:"orders"},
...
export default function Layout({children}:{children:React.ReactNode}){return <ModuleShell brand="estoque" moduleName="Estoque" items={items}>{children}</ModuleShell>}

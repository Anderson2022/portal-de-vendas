            ...
            <tbody>
              {list.map((c) => (
                <tr key={c.id}>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-[11.5px] font-medium text-ink-300">
                          desde {dateShort(c.createdAt)}/
                          {c.createdAt.slice(0, 4)}
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="text-center font-extrabold tabular-nums text-ink-900">
                    {c.purchases}
                  </td>
                  <td className="tabular-nums text-ink-500">
                    {c.lastPurchase ? dateShort(c.lastPurchase) : "—"}
                  </td>
                  <td className="text-right font-extrabold tabular-nums text-ink-900">
                    {brl(c.totalBought)}
                  </td>
                </tr>
              ))}
